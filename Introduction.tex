...
\begin{eqnarray}\label{eq:meansquare1}
%\left<n(t)^{2}\right>&=\lim_{T\rightarrow\infty}\frac{1}{2T}\int_{-\infty}^{\infty}\textrm{d}f\;\int_{-\infty}^{\infty}\textrm{d}f'\;\int_{-T}^{T}\textrm{d}t\; {\cal{F}}\left\{n(\tau+t)\right\}\left[{\cal{F}}\left\{n(\tau+t)\right\}\right]^{*}\nonumber \\
...
&=\int_{-\infty}^{\infty}\textrm{d}f\;\int_{-\infty}^{\infty}\textrm{d}f'\;\left<\tilde{n}(f)\tilde{n}^{*}(f')\right>\nonumber \\
%&= \int_{-\infty}^{\infty}\textrm{d}f\;\int_{-\infty}^{\infty}\textrm{d}f'\;\frac{1}{2}S_{n}(f)\delta (f-f')\nonumber\\
& = \int_{0}^{\infty}\textrm{d}f\; S_{n}(f)
\end{eqnarray}
...
%&=\int_{-\infty}^{\infty}\textrm{d}f\;\int_{-\infty}^{\infty}\textrm{d}t\;\int_{-\infty}^{\infty}\textrm{d}t'\;\frac{1}{2}S_{n}(f)K(t)K^{*}(t')\exp\left(2\pi\rmi f (t-t')\right)\nonumber \\
