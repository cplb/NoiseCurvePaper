...
\begin{eqnarray}
h(t) &=& \sqrt{2} h_0 \cos\left[\rmi \phi(t)\right] \; ; \\
...
\end{equation}
The higher-order terms cause the expoential to oscillate rapidly such that these terms integrate to zero and may be neglected. Performing a similar expansion about $f = -f'$ for the second term in (\ref{eq:fourier-h}) gives
