...
Another disadvantage is that applying (\ref{eq:strain-hc}) to a monochromatic source gives a formally undefined answer. The correct identification of characteristic strain for a monochromatic source is the amplitude of the wave times the square root of the number of periods observed. %% CPLB: Didn't we used to have a section explaining this? Perhaps add ref to 3.1?
