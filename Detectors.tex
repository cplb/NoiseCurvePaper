...
\mr
  ...
  Virgo $^{d}$	& 	Italy		& $3\,\textrm{km}$ 	& 2007-2010 	   & 1$^{\textrm{st}}$\\
  aLIGO $^{e}$	&	US		& $4\,\textrm{km}$ 	& \emph{est.} 2015 & 2$^{\textrm{nd}}$\\
  KAGRA	$^{f}$	&	Japan		& $3\,\textrm{km}$ 	& \emph{est.} 2018 & 2$^{\textrm{nd}}$\\
  AdV $^{g}$	&	Italy	 	& $3\,\textrm{km}$ 	& \emph{est.} 2016 & 2$^{\textrm{nd}}$\\
